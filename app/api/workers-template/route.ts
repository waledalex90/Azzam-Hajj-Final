...
export async function GET() {
  ...
  const helpSheet = XLSX.utils.aoa_to_sheet([
    ...
    ["7) عمود «الوردية» (أو shift): اكتب صباحي أو 1 للصباحي، مسائي أو 2 للمسائي؛ اتركه فارغًا ليظهر العامل في كلا الورديتين في التحضير."],
    ["8) عمود «الحالة» للقراءة في التصدير: نشط أو غير نشط (لا يُستخدم عند الاستيراد)."],
  ]);
