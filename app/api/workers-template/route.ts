...
export async function GET() {
  ...
  const helpSheet = XLSX.utils.aoa_to_sheet([
    ...
    ["3) «كود الموظف» فريد لكل موظف — إن تركته فارغاً يُخزَّن فارغاً، وإن وُجد مكرراً يُرفض الصف مع ذكر رقم الصف."],
    ["4) عمود رقم الهوية/الإقامة/الجواز يجب أن يكون فريدًا (بدون تكرار في الملف أو التحديث الضمني)."],
    ["5) نظام الدفع يقبل: راتب شهري أو راتب يومي."],
    ["6) تاريخ انتهاء الإقامة بصيغة: YYYY-MM-DD."],
    ["7) اسم المقاول واسم الموقع يجب أن يكونا مطابقين للأسماء الموجودة في النظام."],
    ["8) عمود «الوردية» (أو shift): اكتب صباحي أو 1 للصباحي، مسائي أو 2 للمسائي؛ اتركه فارغًا ليظهر العامل في كلا الورديتين في التحضير."],
  ]);
